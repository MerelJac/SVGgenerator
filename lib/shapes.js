...
Shape.prototype.square = (text, textColor, shapeColor) => {
    return `<svg width="200" height="250" version="1.1" xmlns="http://www.w3.org/2000/svg"><g><rect x="40" y="130" width="200" height="200" stroke="${shapeColor}" fill="${shapeColor}" stroke-width="5"/><text x="55" y="120" font-family="Verdana" font-size="70" fill="${textColor}">${text}</text></g></svg>`;
}
