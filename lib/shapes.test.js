...
describe('Shape', () => {
    ...
    describe('triangle', () => {
        it('Should return false if triangle function is not successful', () => {
            const svgFile = `<svg width="200" height="250" version="1.1" xmlns="http://www.w3.org/2000/svg"><g><polygon points="50 15, 100 100, 0 100" stroke="blue" fill="blue" stroke-width="5"/><text x="0" y="50" font-family="Verdana" font-size="35" fill="yellow">abc</text></g></svg>`;
            const shape = new Shape();
    ...
    describe('square', () => {
        it('Should return false if square function is not successful', () => {
            const svgFile = `<svg width="200" height="250" version="1.1" xmlns="http://www.w3.org/2000/svg"><g><rect x="10" y="10" width="200" height="200" stroke="blue" fill="blue" stroke-width="5"/><text x="55" y="120" font-family="Verdana" font-size="70" fill="yellow">abc</text></g></svg>`;
            const shape = new Shape();
